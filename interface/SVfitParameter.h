#ifndef TauAnalysis_SVfit_SVfitVariable_h
#define TauAnalysis_SVfit_SVfitVariable_h
...
class SVfitParameter
{
 public:
  SVfitParameter(int, const std::string&, int, double, double, double, double, bool = false);
  SVfitParameter(int, const std::string&, int, bool = false);
  ...
  // correctly.
  bool operator<(const SVfitParameter& other) const
  {
...
std::ostream& operator<<(std::ostream&, const SVfitParameter&);
