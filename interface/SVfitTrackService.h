#ifndef TauAnalysis_SVfit_SVfitTrackService_h
#define TauAnalysis_SVfit_SVfitTrackService_h

/*
 * SVfitTrackService
 *
 * Central service for interacting with tracks in the SVfit.
...
class SVfitTrackService 
{
 public:
  SVfitTrackService (const edm::ParameterSet&, edm::ActivityRegistry&);
  virtual ~SVfitTrackService() {};
...
#endif /* end of include guard: TauAnalysis_SVfit_SVfitTrackService_h */
