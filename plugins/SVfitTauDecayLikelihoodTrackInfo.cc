#include "TauAnalysis/SVfit/plugins/SVfitTauDecayLikelihoodTrackInfo.h"
...
SVfitTauDecayLikelihoodTrackInfo::SVfitTauDecayLikelihoodTrackInfo(const edm::ParameterSet& cfg)
  : SVfitSingleParticleLikelihood(cfg),
    algorithm_(0)
{
  //std::cout << "<SVfitTauDecayLikelihoodTrackInfo::SVfitTauDecayLikelihoodTrackInfo>:" << std::endl;
...
SVfitTauDecayLikelihoodTrackInfo::~SVfitTauDecayLikelihoodTrackInfo()
{
// nothing to be done yet...
}

void SVfitTauDecayLikelihoodTrackInfo::beginJob(SVfitAlgorithmBase* algorithm)
{
...
double SVfitTauDecayLikelihoodTrackInfo::operator()(const SVfitSingleParticleHypothesis* hypothesis, int polHandedness) const
{
...
DEFINE_EDM_PLUGIN(SVfitSingleParticleLikelihoodPluginFactory, SVfitTauDecayLikelihoodTrackInfo, "SVfitTauDecayLikelihoodTrackInfo");
