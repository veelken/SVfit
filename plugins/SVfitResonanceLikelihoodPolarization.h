#ifndef TauAnalysis_SVfit_plugins_SVfitResonanceLikelihoodPolarization_h
#define TauAnalysis_SVfit_plugins_SVfitResonanceLikelihoodPolarization_h

/** \class SVfitResonanceLikelihoodPolarization
 *
...
class SVfitResonanceLikelihoodPolarization : public SVfitResonanceLikelihood
{
 public:

  SVfitResonanceLikelihoodPolarization(const edm::ParameterSet&);
  ~SVfitResonanceLikelihoodPolarization();
...
#endif /* end of include guard: TauAnalysis_SVfit_plugins_SVfitResonanceLikelihoodPolarization_h */
