 ...
 private:
  ...
  struct plotEntryType
  {
	...
	if ( dynamic_cast<const NSVfitResonanceHypothesisByIntegration*>(svFitResonanceHypothesis) ) {
	  ...
	  double svFitMass_mean3sigOfMax = (dynamic_cast<const NSVfitResonanceHypothesisByIntegration*>(svFitResonanceHypothesis))->mass_mean3sigmaWithinMax();
	  double svFitMass_mean5sigOfMax = (dynamic_cast<const NSVfitResonanceHypothesisByIntegration*>(svFitResonanceHypothesis))->mass_mean5sigmaWithinMax();
